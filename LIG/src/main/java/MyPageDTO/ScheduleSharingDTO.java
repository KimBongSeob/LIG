...
public class ScheduleSharingDTO {
	...
	public ScheduleSharingDTO() {}
	public ScheduleSharingDTO(int share_id, int group_id, String mem_id, String nickname, int day_no, Date start_date, Date end_date,
