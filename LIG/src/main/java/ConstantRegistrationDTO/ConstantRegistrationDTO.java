package ConstantRegistrationDTO;

import java.sql.Date;
import java.text.SimpleDateFormat;

public class ConstantRegistrationDTO {
	private int regist_id;//--등록 ID
	...
	private String dest_name_1;//--여행지 이름
	private String dest_name_2;//--여행지 이름
	private String dest_name_3;//--여행지 이름
	private String dest_name_4;//--여행지 이름
	private String dest_name_5;//--여행지 이름
	...
	public ConstantRegistrationDTO() {}
	public ConstantRegistrationDTO(int regist_id, int group_id, String mem_id,  int day_no, Date start_date, Date end_date,
			String subject, int dest_id_1, int dest_id_2, int dest_id_3, int dest_id_4,
