...
<c:import url="/WEB-INF/view/MyPage/ScheduleSharing/Login.jsp"></c:import>
	<c:choose>
		<c:when test="${sessionScope.mem_id != null}">
			<c:choose>
				<c:when test="${sessionScope.mem_id == 'admin'}">
					<c:import url="/WEB-INF/view/MyPage/ScheduleSharing/admin_header.jsp"></c:import>
				</c:when>
				<c:otherwise>
					<c:import url="/WEB-INF/view/MyPage/ScheduleSharing/login_header.jsp"></c:import>
				</c:otherwise>
			</c:choose>
		</c:when>
		<c:otherwise>
			<c:import url="/WEB-INF/view/MyPage/ScheduleSharing/header.jsp"></c:import>
		</c:otherwise>
				...
				<div class="mypageSubDiv-8">
					<div class="form-group">
						<div class="">
							...
							<div style="display: inline-block; margin-left: 17px;">
								<label class="font-base"><h3>Start Date</h3></label> <input class="form-control"
									id="sdate_value" name="sdate_value" placeholder="날짜를 선택해주세요."
									type="text" readonly />
							</div>
							...
							<div style="display: inline-block; margin-left: 17px;">
								<label class="font-base"><h3>End Date</h3></label> <input class="form-control"
									id="edate_value" name="edate_value" placeholder="날짜를 선택해주세요."
									type="text" readonly />
							</div>
							<div style="display: inline-block; margin-left: 30px;">
