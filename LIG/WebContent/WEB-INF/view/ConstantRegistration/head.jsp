...
<script type="text/javascript" src="<c:url value='/js/ConstantRegistration.js'/>"></script>
			...
			success : function(args) {
				...
				if(page > 0){
					...
					if (endPage < pageCount) {
						var sum = startPage + pageBlock ;
						$("#pageNumDiv").append("<a onclick=\"pageSearch('"+sum+"','"+select_data+"','"+area_m1+"','"+area_m2+"')\" href=\"#\"><span class='ModalpageNumSize'>[다음]</span></a>");
						$("#pageNumDiv").append("<a onclick=\"pageSearch('"+page+"','"+select_data+"','"+area_m1+"','"+area_m2+"')\" href=\"#\"><span class='ModalpageNumSize'>[>>]</sapn></a>");
					}
				}
