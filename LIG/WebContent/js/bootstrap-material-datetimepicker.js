(function($, moment)
{
	...
	Plugin.prototype = 
	{
			...
			this.template = '<div class="dtp hidden" id="' + this.name + '">' +
								'<div class="dtp-content">' +
									...
									'<div class="dtp-buttons">' +
										'<button class="dtp-btn-cancel btn btn-orange-fill">' + this.params.cancelText + '</button>' +
										'<button class="dtp-btn-ok btn btn-orange-fill">' + this.params.okText + '</button>' +
										'<div class="clearfix"></div>' +
									'</div>' +
								'</div>' +
							'</div>';
		...
		setElementValue: function()
		{
			...
			date_ok_button();//이 함수가 start end date 값 set.
		},
